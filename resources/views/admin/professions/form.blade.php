                ...
                <form class="form-validate-jquery" action="{!! $s_form_route !!}" method="post">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane px-2 active" id="main">
                            ...
                            <div class="px-2">
                                <div class="form-group row field" data-name="timezone">
                                    <div class="col-lg-3">
                                        <label class="d-block float-left py-2 m-0">{!! trans('app/professions.form.fields.timezone.label') !!} <span class="text-danger">*</span></label>
                                        <span class="badge badge-primary tooltip-helper d-block float-right my-2 px-1" data-toggle="tooltip" title="{!! trans('app/professions.form.fields.timezone.rules') !!}"><i class="icon-info3"></i></span>
                                    </div>
                                </div>
                            </div>
                            <ul class="nav nav-tabs nav-tabs-highlight">
                                    ...
                                    <div class="tab-pane px-2 {!! $app->getLocale() === $code ? 'active' : ''!!}" id="{!! $code !!}">
                                        <fieldset class="mb-3">
                                            <div class="form-group row field" data-name="{!! $code !!}.name">
                                                <div class="col-lg-3">
                                                    <label class="d-block float-left py-2 m-0">{!! trans('app/professions.form.fields.name.label') !!} <span class="text-danger">*</span></label>
                                                    <span class="badge badge-primary tooltip-helper d-block float-right my-2 px-1" data-toggle="tooltip" title="{!! trans('app/professions.form.fields.name.rules') !!}"><i class="icon-info3"></i></span>
                                                </div>
                                                <div class="col-lg-9 field-body">
                                                    <input type="text" name="{!! $code !!}[name]" class="form-control" placeholder="{!! trans('app/professions.form.fields.name.label') !!}" autocomplete="off" value="{{ $profession->id ? $profession->translate($code)->name : '' }}">
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
                        ...
                        <div class="d-flex justify-content-end align-items-center">
                            <button type="submit" class="btn btn-styled ml-2">{!! trans('app/professions.form.submit') !!} <i class="icon-paperplane ml-2"></i></button>
                        </div>
                    </div>
                </form>
            </div>
