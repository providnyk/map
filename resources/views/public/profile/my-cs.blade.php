...
@section('content')
<div class="content my-cs-page" id="test">
    <div class="container-fluid">
        <div class="title-box">
            <h1 class="title-block">{{ trans('general.my-festival') }}</h1>
            <ul class="nav nav-tabs" id="pressTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="bookmarks-tab" data-toggle="tab" href="#bookmarks-text-tab" role="tab" aria-controls="bookmarks-text-tab" aria-selected="true">{{ trans('general.bookmarks') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile-text-tab" role="tab" aria-controls="profile-text-tab" aria-selected="false">{{ trans('general.user-profile') }}</a>
                </li>
                @if($b_admin)
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <form action="/logout" method="post">
                        @csrf
                        <button class="nav-link">{{ trans('general.log-out') }}</button>
                    </form>
                </li>
            </ul>
        </div>
        ...
        <div class="tab-content section-tab" id="pressTabContent">
            <div class="tab-pane fade show active" id="bookmarks-text-tab" role="tabpanel" aria-labelledby="bookmarks-tab">
            ...
            <div class="tab-pane fade" id="profile-text-tab" role="tabpanel" aria-labelledby="profile-tab">
