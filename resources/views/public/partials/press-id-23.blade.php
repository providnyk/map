<div class="col-lg-4 col-12">
    <div class="news-item press-item video-press">
        <div class="img-wrap">
            ...
            <a><img src="{{ $press->image->small_image_url }}"></a>
        </div>
        <div class="descr">
            <h4 class="press-title"><a>{{ $press->title }}</a></h4>
        ...
        <div class="download-link-wrap">
            @if($press->links->youtube)
                <a href="{{ $press->links->youtube }}" class="btn download-btn d-video">
            ...
            @endif
            @if($press->links->vimeo)
                <a href="{{ $press->links->vimeo }}" class="btn download-btn d-video">
