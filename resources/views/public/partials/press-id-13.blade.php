<div class="col-lg-4 col-12">
    <div class="news-item press-item photos-press">
        <div class="img-wrap">
            <div class="label">{{ $press->type->name }}</div>
            <a href="{{ route('public.festival.gallery', [$festival->slug, $press->slug]) }}">
                <img src="{{ $press->image->small_image_url }}" alt="">
            </a>
        </div>
        <div class="descr">
            <h4 class="press-title"><a href="{{ route('public.festival.gallery', [$festival->slug, $press->slug]) }}">
                {{ $press->title }}
            </a></h4>
        ...
        <div class="download-link-wrap">
            <a href="{{ $press->archive->url }}" class="btn download-btn d-img">
