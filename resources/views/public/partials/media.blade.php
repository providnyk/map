    ...
    <div class="news-item press-item">
        <div class="quote-icon">
            <svg width="59" height="48" viewBox="0 0 59 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M17.2325 0.144531L27.5841 7.17578C21.5294 15.444 18.4044 24.3633 18.2091 33.9336V47.2148H0.240341V35.8867C0.240341 29.2461 1.80284 22.6706 4.92784 16.1602C8.11795 9.64974 12.2195 4.3112 17.2325 0.144531ZM47.9942 0.144531L58.3458 7.17578C52.2911 15.444 49.1661 24.3633 48.9708 33.9336V47.2148H31.0021V35.8867C31.0021 29.2461 32.5646 22.6706 35.6896 16.1602C38.8797 9.64974 42.9812 4.3112 47.9942 0.144531Z" fill="black"></path>
            </svg>
        </div>
        <div class="descr">
            <h4 class="press-title">{{ $media->title }}</h4>
            <div class="short">{{ $media->description }}</div>
        </div>
        <div class="date-box">
            <div class="date">{{ $media->published_at_day }}</div>
            <div class="name">{{ $media->author }}</div>
        </div>
        <div class="download-link-wrap">
            <a href="{{ $media->file->url }}" class="btn download-btn" target="_blank">
