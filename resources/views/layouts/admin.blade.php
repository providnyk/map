        ...
        <ul class="navbar-nav ml-md-auto">
            <li class="nav-item dropdown">
                <a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
                    <img src="/admin/images/lang/{!! $app->getLocale() !!}.png" class="img-flag mr-2" alt=""> {!! $localizations[$app->getLocale()] !!}
                </a>

                <div class="dropdown-menu dropdown-menu-right">
                    @foreach($localizations as $code => $lang)
                        <a href="{{ route('change-lang', $code) }}" class="dropdown-item {!! $code === $app->getLocale() ? 'active' : '' !!}">
                            <img src="/admin/images/lang/{!! $code !!}.png" class="img-flag" alt=""> {!! $lang !!}
                        </a>
                    @endforeach
                    {{--<a href="{{ route('change-lang', 'en') }}" class="dropdown-item active"><img src="/admin/images/lang/en.png" class="img-flag" alt=""> English</a>--}}
                    {{-- <a href="#" class="dropdown-item ukrainian"><img src="/admin/images/lang/ua.png" class="img-flag" alt=""> Українська</a> --}}
                    {{-- <a href="#" class="dropdown-item espana"><img src="/admin/images/lang/es.png" class="img-flag" alt=""> España</a>
                    <a href="#" class="dropdown-item russian"><img src="/admin/images/lang/ru.png" class="img-flag" alt=""> Русский</a> --}}
                </div>
            </li>
