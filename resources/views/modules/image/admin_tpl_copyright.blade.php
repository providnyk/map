...
<div class="col-lg-9 field-body">
    <input type="text" id="copyright-${id}" name="image_copyrights[uploaded_image_id]" class="form-control image_copyright" placeholder="{!! trans('common/form.fields.preview_copyright.label') !!}" autocomplete="off" value="" disabled="disabled">
</div>
