...
<body class="c22">
	...
	<p class="c3">
		...
		<span class="c10 c14">
			у зв’язку з відсутністю належної інклюзивної інфраструктури (доступної для людей з інвалідністю) за наступною адресою:
		</span>
		<span class="c12 c10">:</span>
	</p>
	<p class="c3 c2"><span class="c0"></span></p>
	<p class="c3"><span class="c11">
		{{ $s_address }}, {{ $s_title }}, {{ $s_descr }}
	</span></p>
	<p class="c3 c2"><span class="c0"></span></p>
	<p class="c3">
		<span class="c0">
