...
<body class="c22">
	...
	<p class="c3">
		<span class="c0">ГО «Дебати заради змін» відносить до своїх завдань розбудову громадянського суспільства, підвищення рівня захисту та реалізації прав людини в Україні. Досягнення цих цілей неможливе без рівного включення усіх членів українського суспільства до соціально-політичного життя, у тому числі без надання особам з інвалідністю можливості вести незалежний спосіб життя й усебічно брати участь у всіх аспектах соціально-політичного життя.
		</span>
	</p>
	...
	<p class="c3">
		...
		<span class="c10 c14">
			у зв’язку з відсутністю належної інклюзивної інфраструктури (доступної для людей з інвалідністю) за наступною адресою</span><span class="c12 c10">:</span><span class="c11"> {{ $s_address }}, {{ $s_title }}.
		</span>
	</p>
	<p class="c3 c2"><span class="c0"></span></p>
	<p class="c3">
		<span class="c11">
			{{ $s_descr }}. Проблеми інфраструктури: {{ $a_issues }}.
		</span>
	</p>
	<p class="c3 c2"><span class="c0"></span></p>
	<p class="c3">
	...
	<p class="c8 c2"><span class="c11"></span></p>
	<p class="c8"><span class="c0">Заздалегідь вдячні за вашу відподь!</span></p>
	<p class="c8">
		<span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 186.00px; height: 160.00px;">
			<img alt="" src="http://{{ Request::getHost() }}/images/ngo-stamp.png" width="186" height="160" style="width: 186.00px; height: 160.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title="">
		</span>
	</p>
	<p class="c8"><span class="c0">З повагою,</span></p>
	<p class="c8 c2"><span class="c0"></span></p>
