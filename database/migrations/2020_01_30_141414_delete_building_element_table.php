...
class DeleteBuildingElementTable extends Migration {

    const DB_CONNECTION = 'psc';
    const DB_TABLE_KEY = 'id';
    const DB_NAME_SGL1 = 'building';
    const DB_NAME_SGL2 = 'element';
    const DB_NAME_PLR1 = 'buildings';
    const DB_NAME_PLR2 = 'elements';
	/**
	 * Run the migrations.
	 *
	 * @return void
