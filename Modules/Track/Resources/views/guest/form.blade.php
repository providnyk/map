...
@include('public.partials._profile', ['s_id' => '#addtrack-form'])
...
@section('content')
        ...
        <div class="map_info_block">
            <div id="map_search" style="display:none;">
                <input type="text" trackholder="Поиск" name="s" />
...
{{--
							...
							<div class="user_fields">
								...
								<div class="item">
									...
									<span class="value">
										<input type="email" class="form-control"  trackholder="" name="email">
									</span>
								</div>
...
@include($theme . '::' . $_env->s_utype . '._recaptcha', ['id' => 'create-' . $s_category])
							...
							<div class="buttons">
								<button type="submit" class="confirm">{!! trans('personal::guest.button.add_new_track') !!}</button>
							</div>
						</form>
--}}
@append
          ...
          function findMe( map ) {
              ...
              if (navigator.geolocation) {
                  navigator.geolocation.getCurrentPosition(function(position) {
                      ...
                      findMeMarker.setContent('<div class="mytrackmarker"><span class="ov1"></span><span class="ov2"></span><span class="ov3"></span><span class="ov4"></span></div>');
