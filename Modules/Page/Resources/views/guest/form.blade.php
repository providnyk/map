...
@include('public.partials._profile', ['s_id' => '#addpage-form'])
...
@section('content')
        ...
        <div class="map_info_block">
            <div id="map_search" style="display:none;">
                <input type="text" pageholder="Поиск" name="s" />
...
{{--
							...
							<div class="user_fields">
								...
								<div class="item">
									...
									<span class="value">
										<input type="email" class="form-control"  pageholder="" name="email">
									</span>
								</div>
...
@include($theme . '::' . $_env->s_utype . '._recaptcha', ['id' => 'create-' . $s_category])
							...
							<div class="buttons">
								<button type="submit" class="confirm">{!! trans('personal::guest.button.add_new_page') !!}</button>
							</div>
						</form>
--}}
@append
