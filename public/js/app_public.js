...
jQuery(document).ready(function($) {
    ...
    console.log(typeof cookie_consent, cookie_consent);
    ...
    */
    ...
    function checkSize(){
        if ($(window).width() >= '992'){
            ...
            scrollXItem('.filter-content .sub-event', '.sub-event-item', 4);
            scrollXItem('.more-events .sub-event', '.sub-event-item', 4);
    ...
    {
	    var o_preview = JSON.parse(window.localStorage.getItem('preview'));
	    $(o_preview.element_id).html(o_preview.body);
